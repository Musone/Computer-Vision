...
def main():
    ...
    # fountain40.png
    image_list_fountain = ['fountain4', 'fountain0']
    image_list = [op.join(path, im) for im in image_list_fountain]
    create_pano(image_list, ratio_thres, 1125, 1500,
                num_iter, tol, figsize=(20, 20))
    
    # garden034.png
    garden_tol = 5
    garden_ratio_thresh = 0.7
    image_list_garden = ['garden0', 'garden3', 'garden4']
    image_list = [op.join(path, im) for im in image_list_garden]
    create_pano(image_list, garden_ratio_thresh, 1125, 1500,
                num_iter, garden_tol, figsize=(20, 20))
    
    # irving_out365.png
    irving_tol = 5
    image_list_irving = ['irving_out3', 'irving_out6', 'irving_out5']
    image_list = [op.join(path, im) for im in image_list_irving]
    create_pano(image_list, ratio_thres, 1125, 1500,
                num_iter, irving_tol, figsize=(20, 20))
